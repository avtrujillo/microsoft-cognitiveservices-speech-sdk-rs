...
pub type PropertyId = ::std::os::raw::c_int;
...
pub type _ParticipantChangedReason = ::std::os::raw::c_int;
...
fn bindgen_test_layout__Result_TranslationTextBufferHeader() {
    ...
    fn test_field_bufferSize() {
        assert_eq!(
            unsafe {
                let uninit =
                    ::std::mem::MaybeUninit::<_Result_TranslationTextBufferHeader>::uninit();
                let ptr = uninit.as_ptr();
    ...
    fn test_field_numberEntries() {
        assert_eq!(
            unsafe {
                let uninit =
                    ::std::mem::MaybeUninit::<_Result_TranslationTextBufferHeader>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).numberEntries) as usize - ptr as usize
            },
            8usize,
            concat!(
                "Offset of field: ",
    ...
    test_field_numberEntries();
    fn test_field_targetLanguages() {
        assert_eq!(
            unsafe {
                let uninit =
                    ::std::mem::MaybeUninit::<_Result_TranslationTextBufferHeader>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).targetLanguages) as usize - ptr as usize
            },
            16usize,
            concat!(
                "Offset of field: ",
    ...
    test_field_targetLanguages();
    fn test_field_translationTexts() {
        assert_eq!(
            unsafe {
                let uninit =
                    ::std::mem::MaybeUninit::<_Result_TranslationTextBufferHeader>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).translationTexts) as usize - ptr as usize
            },
            24usize,
            concat!(
                "Offset of field: ",
...
#[doc = " </summary>"]
pub type Audio_Stream_Container_Format = ::std::os::raw::c_int;
extern "C" {
...
pub type Result_Reason = ::std::os::raw::c_int;
...
pub type Result_CancellationReason = ::std::os::raw::c_int;
...
pub type Result_CancellationErrorCode = ::std::os::raw::c_int;
...
pub type Result_NoMatchReason = ::std::os::raw::c_int;
...
pub type Synthesis_VoiceType = ::std::os::raw::c_int;
extern "C" {
...
pub type Stream_Status = ::std::os::raw::c_int;
extern "C" {
...
#[doc = " </summary>"]
pub type AudioProcessingOptions_PresetMicrophoneArrayGeometry = ::std::os::raw::c_int;
...
#[doc = " </summary>"]
pub type AudioProcessingOptions_MicrophoneArrayType = ::std::os::raw::c_int;
#[doc = " <summary>"]
...
#[doc = " </summary>"]
pub type AudioProcessingOptions_SpeakerReferenceChannel = ::std::os::raw::c_int;
#[doc = " <summary>"]
...
fn bindgen_test_layout_AudioProcessingOptions_MicrophoneCoordinates() {
    ...
    fn test_field_X() {
        assert_eq!(
            unsafe {
                let uninit =
                    ::std::mem::MaybeUninit::<AudioProcessingOptions_MicrophoneCoordinates>::uninit(
                    );
                let ptr = uninit.as_ptr();
...
fn bindgen_test_layout_AudioProcessingOptions_MicrophoneArrayGeometry() {
    ...
    fn test_field_microphoneArrayType() {
        assert_eq!(
            unsafe {
                ...
                >::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).microphoneArrayType) as usize - ptr as usize
            },
            0usize,
            concat!(
                "Offset of field: ",
    ...
    test_field_microphoneArrayType();
    fn test_field_beamformingStartAngle() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<
                    AudioProcessingOptions_MicrophoneArrayGeometry,
                >::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).beamformingStartAngle) as usize - ptr as usize
            },
            4usize,
            concat!(
                "Offset of field: ",
    ...
    test_field_beamformingStartAngle();
    fn test_field_beamformingEndAngle() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<
                    AudioProcessingOptions_MicrophoneArrayGeometry,
                >::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).beamformingEndAngle) as usize - ptr as usize
            },
            6usize,
            concat!(
                "Offset of field: ",
    ...
    test_field_beamformingEndAngle();
    fn test_field_numberOfMicrophones() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<
                    AudioProcessingOptions_MicrophoneArrayGeometry,
                >::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).numberOfMicrophones) as usize - ptr as usize
            },
            8usize,
            concat!(
                "Offset of field: ",
    ...
    test_field_numberOfMicrophones();
    fn test_field_microphoneCoordinates() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<
                    AudioProcessingOptions_MicrophoneArrayGeometry,
                >::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).microphoneCoordinates) as usize - ptr as usize
            },
            10usize,
            concat!(
                "Offset of field: ",
    ...
    test_field_microphoneCoordinates();
}
...
pub type SpeechOutputFormat = ::std::os::raw::c_int;
...
pub type Speech_Synthesis_Output_Format = ::std::os::raw::c_int;
...
pub type SpeechConfig_ServicePropertyChannel = ::std::os::raw::c_int;
...
pub type SpeechConfig_ProfanityOption = ::std::os::raw::c_int;
extern "C" {
...
pub type SpeechSynthesis_BoundaryType = ::std::os::raw::c_int;
extern "C" {
...
pub type GrammarList_RecognitionFactorScope = ::std::os::raw::c_int;
extern "C" {
...
fn bindgen_test_layout_codec_c_interface() {
    ...
    fn test_field_init() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<codec_c_interface>::uninit();
                let ptr = uninit.as_ptr();
    ...
    test_field_init();
    fn test_field_get_format_type() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<codec_c_interface>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).get_format_type) as usize - ptr as usize
            },
            8usize,
            concat!(
                "Offset of field: ",
    ...
    test_field_flush();
    fn test_field_endstream() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<codec_c_interface>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).endstream) as usize - ptr as usize
            },
            32usize,
            concat!(
                "Offset of field: ",
...
pub type Pronunciation_Assessment_Grading_System = ::std::os::raw::c_int;
...
pub type Pronunciation_Assessment_Granularity = ::std::os::raw::c_int;
extern "C" {
